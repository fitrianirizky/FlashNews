...
import com.rizky.flashnews.R
import com.rizky.flashnews.domain.model.Article
// PENTING: Import komponen TranslatedText kamu
...
fun BottomSheetContent(
    ...
    Surface(modifier = Modifier.padding(16.dp)) {
        Column(horizontalAlignment = Alignment.CenterHorizontally) {
            ...
            // Gambar (ImageHolder atau AsyncImage)
            ...
            Button(
                ...
                Text(text = stringResource(id = R.string.read_full_story))
            }
        }
    }
}